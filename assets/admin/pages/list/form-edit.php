...
?>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Edit School</h3>
        </div>
        <!-- /.card-header -->
        <form role="form" action="insert.php" method="post"enctype="multipart/form-data"id="formRegister">
          <div class="card-body">
            ...
            <table>
              <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="school_name" name="school_name" value="<?php echo $rows['school_name']?>"disabled>

              </div>
              <div class="form-group col-md-12">
                  <label for="school_add">School Detail </label><br>
                  <textarea name="school_add"  id="school_add" rows="5" class="form-control"disabled><?php echo $rows['school_add']?></textarea>
              </div>
               <div class="form-group col-md-2">
                  <label for="school_level">Level</label>
                  <div class="input-group-prepend">
                  <input type="text" class="form-control" id="school_level" name="school_level" class="form-control" value="<?php echo $rows['school_level']?>"disabled>
                  
                  </div>
              </div>
              <div class="form-group col-md-2">
                  <label for="school_link">Link of School Web</label>
                  <input type="text" class="form-control" id="school_link" name="school_link"value="<?php echo $rows['school_link']?>"disabled>
              </div>
              <div class="form-group col-md-2">
                  <label for="school_tag">School Tag</label>
                  <input type="text" class="form-control" id="school_tag" name="school_tag"value="<?php echo $rows['school_tag']?>"disabled>
              </div>
              <div class="form-group col-md-2">
                  <label for="school_date">Date</label>
                  <input type="date" class="form-control" id="school_date" name="school_date"value="<?php echo $rows['school_date']?>"disabled>
              </div>
          ...
          <a href="form-edit2.php?school_id=<?php echo $rows['school_id']?>"class="btn btn-warning float-right">edit</a>
          </div>
          </div>
            </table>
            </div>
