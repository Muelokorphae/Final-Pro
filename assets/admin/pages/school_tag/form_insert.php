  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>School Type Management</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">Setting</a></li>
              <li class="breadcrumb-item"><a href="../stores">School Type Management</a></li>
              <li class="breadcrumb-item active">Add School Type</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Add School Type</h3>
        </div>
        <!-- /.card-header -->
          ...
          <div class="card-body">
            ...
            <table>
              ...
              <div class="form-group col-md-4">
                  <label for="school_tag_id">School Type ID</label>
                  <input type="text" class="form-control" id="school_tag_id" name="school_tag_id">
              </div>
              <div class="form-group col-md-4">
                  <label for="school_tag_name">School Type Name</label>
                  <input type="text" class="form-control" id="school_tag_name" name="school_tag_name">
              </div>
